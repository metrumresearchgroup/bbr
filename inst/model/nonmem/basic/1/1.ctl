...
$TABLE NUM CL NOAPPEND NOPRINT ONEHEADER FIRSTONLY FILE=1twotables.tab ; for testing two tables in one file
$TABLE ID CL NOAPPEND NOPRINT ONEHEADER FIRSTONLY FILE=1twotables.tab ; for testing two tables in one file ^
