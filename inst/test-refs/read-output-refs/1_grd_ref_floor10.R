structure(list(ITERATION = c(15, 20, 25, 28), `GRD(1)` = c(
  67.719,
  1.65157, 0.054693, 0.0156865
), `GRD(2)` = c(
  -4.43742, 8.79741,
  -4.32156, -0.0208362
), `GRD(3)` = c(
  -64.8055, 5.48268, 0.224461,
  -0.14475
), `GRD(4)` = c(-9.18293, -3.89742, 0.545465, 0.0578819), `GRD(5)` = c(-116.424, -9.09877, 5.88495, -0.0519504), `GRD(6)` = c(
  8.17142,
  -2.71363, -0.323596, -0.0186751
), `GRD(7)` = c(
  15.7085, 19.0962,
  1.75471, 0.00342784
)), class = c(
