...
ABS_MODEL_DIR <- system.file(file.path("model", "nonmem", "basic"),   package = "rbabylon")
...
MODEL_DIR_X <- fs::path_rel(system.file(file.path("model", "nonmem", "complex"),   package = "rbabylon"), getwd()) %>% as.character()
