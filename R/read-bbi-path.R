#' Set the path to the babylon executable
#'
#' [withr::with_options()] is used throughout package tests to set the path to
#' the babylon executable. The test suite will fail if this path does not exist,
...
#'
#' @param path path to the babylon executable
...
#' @keywords internal
#' @export
read_bbi_path <- function(path = Sys.getenv("BABYLON_EXE_PATH", NA),
