...
# TODO: this will be cleaned up in #165
# delete old files
cleanup <- function() {
  nonmem_path <- system.file("nonmem", package = "rbabylon")
  ...
  if (fs::file_exists(file.path(nonmem_path, "1.yaml"))) fs::file_delete(file.path(nonmem_path, "1.yaml"))
}
cleanup()
```
