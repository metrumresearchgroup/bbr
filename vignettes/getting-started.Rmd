...
To use `rbabylon` you must first install `babylon`, often aliased as `bbi`, on your system. Check the [babylon documentation](https://github.com/metrumresearchgroup/babylon) for installation instructions.
